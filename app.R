...
#Feature #1 is adding a layout. This is useful because I can separate the side bar to be where the user adjusts the variable and have a table populate in the main panel beside rather than below. 
sidebarLayout(
  sidebarPanel(
#Feature #2 is adding interactive selection buttons and sliders. This is useful so that the user can enter a few qualities they are looking for to find only penguins that fit their criteria. 
...
#within fluid page put citation to dataset in actual letters that show up in app and reference in readme 
...
#Feature #3 is an ouput table. This is useful as it provides the user with a list of penguins that fit the criteria that have searched for.   
